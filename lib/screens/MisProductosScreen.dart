    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: Icon(Icons.add),
            onPressed: () async {
              // Navega a la pantalla de añadir, sin datos -> modo “nuevo”
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snap) {
          ...
          if (docs.isEmpty) return Center(child: Text('No has subido productos aún'));
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  trailing: Row(
                    ...
                    children: [
                      ...
                      IconButton(
                        ...
                        onPressed: () async {
                          // Navegar a AddProductScreen en modo edición:
                          await Navigator.push(
                            context,
                            MaterialPageRoute(
                  ...
                  onTap: () => Navigator.push(
                    context,
                    MaterialPageRoute(builder: (_) => ProductDetailScreen(productData: productMap)),
                  ),
                ),
              );
            },
